...
```bash
go get -u github.com/kawai-network/veridium/pkg/htmltomarkdown
```
...
[![Go V2 Reference](https://pkg.go.dev/badge/github.com/kawai-network/veridium/pkg/htmltomarkdown.svg)](https://pkg.go.dev/github.com/kawai-network/veridium/pkg/htmltomarkdown)
...
```bash
go install github.com/kawai-network/veridium/pkg/htmltomarkdown/cli/html2markdown@latest
```
