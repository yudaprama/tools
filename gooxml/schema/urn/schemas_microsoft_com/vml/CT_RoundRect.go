...
import (
	...
	"github.com/yudaprama/tools/gooxml/schema/urn/schemas_microsoft_com/office/powerpoint"
	"github.com/yudaprama/tools/gooxml/schema/urn/schemas_microsoft_com/office/word"
)
	...
	for {
		...
		case xml.StartElement:
			...
			case xml.Name{Space: "urn:schemas-microsoft-com:office:powerpoint", Local: "textdata"}:
				...
				m.EG_ShapeElements = append(m.EG_ShapeElements, tmpshapeelements)
			default:
				gooxml.Log("skipping unsupported element on CT_RoundRect %v", el.Name)
